...
import { HelpCircle, FileText, Mail, ChevronDown, PenTool, Video, Smile, Type, ExternalLink, Instagram, ChevronRight } from 'lucide-react';

const divisions = [
  { name: "Desain Grafis", icon: PenTool, color: "text-purple-400", bg: "bg-purple-500/5", border: "hover:border-purple-500/50" },
  { name: "Video Editing", icon: Video, color: "text-blue-400", bg: "bg-blue-500/5", border: "hover:border-blue-500/50" },
  { name: "Meme Creator", icon: Smile, color: "text-yellow-400", bg: "bg-yellow-500/5", border: "hover:border-yellow-500/50" },
  { name: "Karya Tulis", icon: Type, color: "text-rose-400", bg: "bg-rose-500/5", border: "hover:border-rose-500/50" },
];
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {divisions.map((div, i) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className={`relative bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 hover:bg-[#111] transition-all group overflow-hidden ${div.border}`}
                  >
                      <Noise />
