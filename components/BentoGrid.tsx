        ...
        <div className="relative z-10 flex justify-between items-start">
           <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2">
                 ...
                 <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-400">Update Terbaru</span>
              </div>
          ...
          <div className="flex items-end justify-between gap-4">
             <div className="space-y-4 max-w-md">
                <div className="inline-block px-3 py-1 rounded-md border border-white/10 bg-white/5 backdrop-blur-md text-xs font-mono text-gray-300">
                   Vol. 4: Futurisme Nostalgia
                </div>
                <p className="text-gray-400 text-sm leading-relaxed border-l border-white/10 pl-4">
                   Tantangan visual menggabungkan estetika masa lalu dengan visi masa depan. Batas pengumpulan diperpanjang.
                </p>
             </div>
